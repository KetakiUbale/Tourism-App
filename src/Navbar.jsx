...
const Navbar = () => {
  ...
  <div className="container-fluid">
    <NavLink exact className="navbar-brand" to="/">Welcome to  "Happy Journey.com "</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink activeClassName="menu_active" exact className="nav-link" to="/package">Packages</NavLink>
        </li>
